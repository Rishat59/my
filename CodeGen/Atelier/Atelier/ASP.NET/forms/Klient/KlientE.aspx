...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="KlientE.aspx.cs" Inherits="IIS.Atelier.КлиентE" %>
...
<asp:RequiredFieldValidator ID="ctrlМастерRequiredFieldValidator" runat="server" ControlToValidate="ctrlМастер"
                            ErrorMessage="Не указано: Мастер" Text="*" 
                            EnableClientScript="true" ValidationGroup="savedoc" />

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlМастер_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlМастер_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
